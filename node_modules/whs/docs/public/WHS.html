...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>WHS</h1>
...
<header>
  ...
  <article>
      <div class="container-overview">
              ...
              <div class="description"><p>Namespace containing all classes from all modules. Used as global in UMD pattern.</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/index.js">index.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/index.js#L1">line 1</a>
    </li></ul></dd>
        ...
        <p class="code-caption">The use of WHS namespace.</p>
    
    <pre class="prettyprint"><code>new WHS.App() // core
new WHS.PerspectiveCamera() // components
new WHS.ResizeModule() // modules
WHS.extend() // utils</code></pre>
