...
<head>
    ...
    <title>Octahedron - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Octahedron</h1>
...
<header>
        ...
        Octahedron
            ...
            <div class="class-description"><iframe src="https://threejs.org/docs/scenes/geometry-browser.html#OctahedronGeometry"></iframe></div>
...
<div class="section-method" id="Octahedron">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Octahedron<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>In geometry, an octahedron is a polyhedron with eight faces.
A regular octahedron is a Platonic solid composed of eight equilateral triangles, four of which meet at each vertex.
<br/><br/>
<code>Octahedron</code> creates an Octahedron object by its <code>radius</code> and <code>detail</code>.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Octahedron.js">components/meshes/Octahedron.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Octahedron.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating an Octahedron, and adding to app</p>
    
    <pre class="prettyprint"><code>new Octahedron({
  geometry: {
    radius: 2,
    detail: 1
  },
              ...
              <code style="display: block;"><pre>
{
  geometry: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Octahedron.js">components/meshes/Octahedron.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Octahedron.js#L57">line 57</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Octahedron.js">components/meshes/Octahedron.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Octahedron.js#L49">line 49</a>
    </li></ul></dd>
