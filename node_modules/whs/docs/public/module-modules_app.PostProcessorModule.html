...
<head>
    ...
    <title>PostProcessorModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>PostProcessorModule</h1>
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <ul class="sub ">
        ...
        <li><a href="#.renderToScreen">.renderToScreen()</a></li>
...
<div class="section-method" id="PostProcessorModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new PostProcessorModule<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js">modules/app/PostProcessorModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js#L15">line 15</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption"> Creating a rendering module and passing it to App's modules</p>
...
<div class="section-method" id=".get">
    ...
    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>get<span class="signature">(name)</span><span class="type-signature"> &rarr; {this}</span></h4>
...
<div class="description">
    <p>Returns a pass by the given name</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js">modules/app/PostProcessorModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js#L168">line 168</a>
    </li></ul></dd>
...
<div class="section-method" id=".pass">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>pass<span class="signature">(pass)</span><span class="type-signature"> &rarr; {this}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js">modules/app/PostProcessorModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js#L116">line 116</a>
    </li></ul></dd>
...
<span class="param-type"><code>Pass</code></span>
...
<div class="section-method" id=".render">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>render<span class="signature">()</span><span class="type-signature"> &rarr; {this}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js">modules/app/PostProcessorModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js#L92">line 92</a>
    </li></ul></dd>
...
<div class="section-method" id=".renderToScreen">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>renderToScreen<span class="signature">(name<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {this}</span></h4>
...
<div class="description">
    <p>Sets the renderToScreen property of currentPass</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js">modules/app/PostProcessorModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js#L184">line 184</a>
    </li></ul></dd>
...
<div class="section-method" id=".shader">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>shader<span class="signature">(material, textureID)</span><span class="type-signature"> &rarr; {this}</span></h4>
...
<div class="description">
    <p>Adds a pass made from shader material</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js">modules/app/PostProcessorModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/PostProcessorModule.js#L140">line 140</a>
    </li></ul></dd>
...
<span class="param-type"><code>Material</code></span>
...
<span class="param-type"><code>String</code></span>
            ...
            <td class="description last">
                <p>Name of the readBuffer uniform</p>
