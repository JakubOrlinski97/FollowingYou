...
[].slice.call(folders).forEach(function (folder) {
  folder.addEventListener('click', function() {
    ...
    <section class="readme">
        <article><h1>Basic scene</h1><p>To create whitestorm.js app you should make a basic HTML document with <code>html</code>, <code>head</code> and <code>body</code> tags. Next step is to include Whitestorm.js to the document and main app script file. You can do it simply using <code>script</code> tag.</p>
...
<p>Try this <a href="https://whs-dev.surge.sh/examples/#basic/helloworld">helloworld demo online</a>.</p>
<h2>App</h2><p>The first thing you should setup is the App object. <strong>When you do this, you do multiple things at once:</strong></p>
<ul>
<li>Setup <code>THREE.Scene</code></li>
<li>Make a perspective camera and add it to the scene.</li>
<li>Apply background and other renderer options.</li>
<li>Set auto resize (in addition).</li>
</ul>
<pre class="prettyprint source lang-js"><code>const app = new WHS.App([
...
]);</code></pre><p><a href="Loops &amp; 3D Animation.html">&gt; Loops &amp; 3D Animation</a></p>
<h2>FAQ</h2><blockquote>
<p>Q: Why is the color in Hexadecimal format?</p>
<p>A: Simply following Three.js' <a href="https://threejs.org/docs/api/math/Color.html">best practice</a>.</p>
</blockquote></article>
    </section>
