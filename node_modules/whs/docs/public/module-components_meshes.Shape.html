...
<head>
    ...
    <title>Shape - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Shape</h1>
...
<header>
        ...
        Shape
            ...
            <div class="class-description"><iframe src="https://threejs.org/docs/scenes/geometry-browser.html#ShapeGeometry"></iframe></div>
...
<div class="section-method" id="Shape">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Shape<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Shape is a universal class. It allows you to create different 2D shapes in 3D scene.<br/>
...
<br/><br/>
<code>Shape</code> consists of shapes that are in its shapes parameter.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js">components/meshes/Shape.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a plane looking Shape from a THREE.Shape, and adding it to app</p>
    
    <pre class="prettyprint"><code>const rectWidth = 10,
rectLength = 5;
              ...
              <code style="display: block;"><pre>
{
  geometry: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js">components/meshes/Shape.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js#L43">line 43</a>
    </li></ul></dd>
              ...
              <code style="display: block;"><pre>
{
  geometry: ['shapes']
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js">components/meshes/Shape.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js#L76">line 76</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js">components/meshes/Shape.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Shape.js#L67">line 67</a>
    </li></ul></dd>
