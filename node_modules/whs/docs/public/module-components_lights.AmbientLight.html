...
<head>
    ...
    <title>AmbientLight - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>AmbientLight</h1>
...
<div class="section-method" id="AmbientLight">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new AmbientLight<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>AmbientLight is a simple class, it extends Light and inherits all its methods.
AmbientLight creates basic light around all scene, so it doesn't need properties like pos or target.
It supports only color and intensity as parameters, which defines the color of the surrounded light and intensity of light.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/lights/AmbientLight.js">components/lights/AmbientLight.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/lights/AmbientLight.js#L6">line 6</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating an AmbientLight </p>
    
    <pre class="prettyprint"><code>new AmbientLight({
  color: 0xffffff,
  intensity: 0.2
}).addTo(world);</code></pre>
