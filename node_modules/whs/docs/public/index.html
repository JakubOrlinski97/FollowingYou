...
<head>
    ...
    <title>Welcome - Documentation</title>
...
[].slice.call(folders).forEach(function (folder) {
  folder.addEventListener('click', function() {
    ...
    <section class="readme">
        <article><h1>Welcome to whs.js docs!</h1><p><strong>whs.js</strong> is a framework for 3D web apps built with Three.js technology.</p>
<pre class="prettyprint source lang-bash"><code># Install npm version
$ npm install whs</code></pre><p>It implements a core with component system and plugin support for fast development of 3D scene with physics.</p>
<p>Automizing your web app with whitestorm is fast and comfortable. This engine has physics support implemented by custom Physi.js library, which is much faster than others. Framework provides extended component control and high frame rate, because it uses WebWorkers technology for multithreading.</p>
<pre class="prettyprint source lang-javascript"><code>const app = new WHS.App([
...
app.start(); // Run app.</code></pre><p><a href="Showcase.html">&gt; featured projects</a></p></article>
    </section>
