...
<head>
    ...
    <title>OrbitControlsModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>OrbitControlsModule</h1>
...
<div class="section-method" id="OrbitControlsModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new OrbitControlsModule<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/controls/OrbitControlsModule.js">modules/app/controls/OrbitControlsModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/controls/OrbitControlsModule.js#L6">line 6</a>
    </li></ul></dd>
...
<span class="param-type"><code>Object</code></span>
            ...
            <td class="description last">
                <p>Object to which controls are aplied.</p>
...
<span class="param-type"><code>THREE.Vector3</code></span>
        ...
        <tr>
                ...
                <td class="name"><code>follow</code></td>
