...
<head>
    ...
    <title>Loops & 3D Animation - Documentation</title>
...
[].slice.call(folders).forEach(function (folder) {
  folder.addEventListener('click', function() {
    ...
    <section class="readme">
        <article><h1>Loops &amp; 3D Animation</h1><div class="embed" style="border-radius: 4px; overflow: hidden; height:400px;">
...
<p>You don't need to write <code>animate()</code> function like you do in Three.js. The problem is that bigger you app become, the bigger your <code>animate()</code> function is.</p>
<p>Here comes <code>WHS.Loop</code> class. With just a few lines of code you can your own mini-animate() function:</p>
...
new WHS.Loop(() => {
  box.rotation.y += 0.02;
}).start(app);</code></pre><p>And you can make loop temporary like that:</p>
<pre class="prettyprint source lang-js"><code>const loop = new WHS.Loop((clock) => {
  // ...
  if (clock.getElapsedTime() > 5) loop.stop(app);
});

loop.start(app);</code></pre><p>This loop will be destroyed after 5 seconds.</p>
<p><a href="Groups.html">&gt; Groups</a></p></article>
    </section>
