...
<head>
    ...
    <title>CubeCamera - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>CubeCamera</h1>
...
<div class="section-method" id="CubeCamera">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new CubeCamera<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Creates 6 cameras that render to a WebGLRenderTargetCube</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/CubeCamera.js">components/cameras/CubeCamera.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/CubeCamera.js#L6">line 6</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creates a CubeCamera and set it as app's camera</p>
    
    <pre class="prettyprint"><code>const camera = new CubeCamera({
  camera: {
    cubeResolution: 256
  },
              ...
              <code style="display: block;"><pre>
{
  camera: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/CubeCamera.js">components/cameras/CubeCamera.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/CubeCamera.js#L37">line 37</a>
    </li></ul></dd>
