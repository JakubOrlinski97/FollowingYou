...
<head>
    ...
    <title>DefineModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>DefineModule</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-modules.html">modules</a>/</span>
...
<div class="section-method" id="DefineModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new DefineModule<span class="signature">(name, data)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/DefineModule.js">modules/DefineModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/DefineModule.js#L1">line 1</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption"> Creating a DefineModule with PerspectiveCamera as camera module and passing it to App's modules</p>
