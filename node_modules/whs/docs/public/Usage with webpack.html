...
<head>
    ...
    <title>Usage with webpack - Documentation</title>
...
[].slice.call(folders).forEach(function (folder) {
  folder.addEventListener('click', function() {
    ...
    <section class="readme">
        <article><h1>Usage with webpack</h1><blockquote>
<p>For better understanding see <a href="https://github.com/WhitestormJS/whitestorm-app-boilerplate">whitestorm-app-boilerplate</a></p>
</blockquote>
<h2>Using predefined alias</h2><p>WhitestormJS provides alias configuration for all its source files to help you build awesome applications with webpack or other tools even faster.</p>
<pre class="prettyprint source lang-js"><code>import alias from 'whs/tools/alias';
...
}</code></pre><p>With just a few lines of setup - you can use our shorteners for src/ files:</p>
<ul>
<li><code>@three</code> - Three.js used in Whitestorm.js</li>
<li><code>@whs:app</code> - App modules</li>
<li><code>@whs:app/element</code> - Alias for specific app module (<code>camera</code>, <code>rendering</code>, ..)</li>
<li><code>@whs:controls</code> - Controls modules</li>
<li><code>@whs:controls/oribt</code> - Alias for specific controls module (... <code>firstperson</code>)</li>
<li><code>@whs+meshes</code> - Mesh components</li>
<li><code>@whs+meshes/Box</code>, <code>@whs+meshes/Sphere</code>, and so on....</li>
<li><code>@whs+lights</code> - Light components</li>
<li><code>@whs+lights/AmbientLight</code>, <code>@whs+lights/DirectionalLight</code>, ...</li>
</ul>
<p> <a href="Modules.html">&gt; Modules</a></p></article>
    </section>
