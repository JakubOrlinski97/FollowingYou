...
<head>
    ...
    <title>Parametric - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Parametric</h1>
...
<header>
        ...
        Parametric
            ...
            <div class="class-description"><iframe src="https://threejs.org/docs/scenes/geometry-browser.html#ParametricGeometry"></iframe></div>
...
<div class="section-method" id="Parametric">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Parametric<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p><code>Parametric</code> generates a geometry representing a <a href='https://en.wikipedia.org/wiki/Parametric_surface'>Parametric surface</a>
<br/><br/>
...
<br/></p>
<ul>
<li><a href='http://math.hws.edu/graphicsbook/source/threejs/curves-and-surfaces.html'>Parametric surface</a></li>
<li><a href='https://stemkoski.github.io/Three.js/Graphulus-Surface.html'>&quot;Graphulus&quot;</a>
<br/><br/></li>
</ul>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Parametric.js">components/meshes/Parametric.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Parametric.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Example creating an heightfield-like geometry. `u` and `v` are like `x` and `y` in shape, but their values are always from `0` to `1`.
We use them in `THREE.Vector3` like `x` and `z` and `Math.random() * 5` for `y`.</p>
    
    <pre class="prettyprint"><code>const createParametric = (u, v) => {
              ...
              <code style="display: block;"><pre>
{
  geometry: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Parametric.js">components/meshes/Parametric.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Parametric.js#L58">line 58</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Parametric.js">components/meshes/Parametric.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Parametric.js#L50">line 50</a>
    </li></ul></dd>
