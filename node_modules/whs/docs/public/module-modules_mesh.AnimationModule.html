...
<head>
    ...
    <title>AnimationModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>AnimationModule</h1>
...
<header>
        ...
        <h2>
            <span class="ancestors"><a href="module-modules_mesh.html">modules/mesh</a>/</span>
...
<div class="section-method" id="AnimationModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new AnimationModule<span class="signature">(app, isDeferred<span class="signature-attributes">opt</span>, params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Convenience module that wraps the <a href='https://threejs.org/docs/#manual/introduction/Animation-system'>three.js animation system</a></p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/AnimationModule.js">modules/mesh/AnimationModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/AnimationModule.js#L5">line 5</a>
    </li></ul></dd>
...
<span class="param-type"><code>App</code></span>
        ...
        <tr>
                ...
                <td class="name"><code>isDeferred</code></td>
...
<span class="param-type"><code>Boolean</code></span>
            ...
            <td class="description last">
                <p>set to true if animation should not start automatically</p>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Create animation module and play a given clip of an imported model</p>
    
    <pre class="prettyprint"><code>const animationModule = new AnimationModule(app, false, {
...
<div class="section-method" id="play">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>play<span class="signature">(clipName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/AnimationModule.js">modules/mesh/AnimationModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/AnimationModule.js#L62">line 62</a>
    </li></ul></dd>
...
<div class="section-method" id="update">
    ...
    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>update<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Update the mixer (being called on frame animation loop)</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/AnimationModule.js">modules/mesh/AnimationModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/AnimationModule.js#L80">line 80</a>
    </li></ul></dd>
