...
<head>
    ...
    <title>TextureModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>TextureModule</h1>
...
<div class="section-method" id="TextureModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new TextureModule<span class="signature">(textures<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>A TextureModule can be applied to any Mesh or Model.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/TextureModule.js">modules/mesh/TextureModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/TextureModule.js#L5">line 5</a>
    </li></ul></dd>
...
<h5>Examples</h5>
        ...
        <p class="code-caption">Creating an instance. url takes a path, or a data object.</p>
    
    <pre class="prettyprint"><code>var woodTexture = new TextureModule({
  url: `${process.assetsPath}/textures/wood.jpg`
});</code></pre>

        <p class="code-caption">More comprehensive example, wood texture applied to a Box.</p>
