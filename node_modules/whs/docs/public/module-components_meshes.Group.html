...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Group</h1>
...
<div class="section-method" id="Group">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Group<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Sometimes you need to make groups of objects (it's not conveniently to apply transforms to each object when can make just one to a group).<br/>
In Three.js you make it using <code>THREE.Object3D</code> and it's children. <br/><br/>
In whs.js we have <code>Group</code></p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Group.js">components/meshes/Group.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Group.js#L5">line 5</a>
    </li></ul></dd>
...
<h5>Examples</h5>
        ...
        <p class="code-caption">Approach 2 - Adding objects to an empty group</p>
    
    <pre class="prettyprint"><code>const sphere = new Sphere();
const box = new Box();
const group = new Group();

sphere.addTo(group);
box.addTo(group);</code></pre>

        <p class="code-caption">Approach 2 - Making a group from objects</p>
    
    <pre class="prettyprint"><code>const sphere = new Sphere();
const box = new Box();
const group = new Group(box, sphere);
// OR: const group = new Group([box, sphere]);</code></pre>
...
<dl class="details">
  ...
  scale: {x: 1, y: 1, z: 1}
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/core/MeshComponent.js">core/MeshComponent.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/core/MeshComponent.js#L25">line 25</a>
    </li></ul></dd>
