...
<head>
    ...
    <title>Importer - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Importer</h1>
...
<div class="section-method" id="Importer">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Importer<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Importer is a loader for meshes and any other data to your scene</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js">components/meshes/Importer.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a Importer, and adding to app</p>
    
    <pre class="prettyprint"><code>new Importer({
              ...
              <code style="display: block;"><pre>
{
  ...
  parser(geometry, materials) {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js">components/meshes/Importer.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js#L52">line 52</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js">components/meshes/Importer.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js#L93">line 93</a>
    </li></ul></dd>
...
<div class="section-method" id=".filter">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>filter<span class="signature">(object, filter)</span><span class="type-signature"> &rarr; {THREE.Mesh}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js">components/meshes/Importer.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Importer.js#L31">line 31</a>
    </li></ul></dd>
...
<span class="param-type"><code>THREE.Mesh</code></span>
            ...
            <td class="description last">
                <p>Instance for iterating through it's children.</p>
...
<span class="param-type"><code>function</code></span>
            ...
            <td class="description last">
                <p>Function with child as argument, should return a boolean whether include the child or not.</p>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Removing unnecessary lights from children</p>
    
    <pre class="prettyprint"><code>new Icosahedron({
  loader: new THREE.OBJLoader(),
