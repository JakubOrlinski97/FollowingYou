...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Box</h1>
...
<header>
        ...
        Box
            ...
            <div class="class-description"><iframe src="https://threejs.org/docs/scenes/geometry-browser.html#BoxGeometry"></iframe></div>
...
<div class="section-method" id="Box">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Box<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js">components/meshes/Box.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a Box, and adding to app</p>
    
    <pre class="prettyprint"><code> new Box({
   geometry: {
     width: 2,
     height: 2,
     depth: 2
              ...
              <code style="display: block;"><pre>
{
  geometry: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js">components/meshes/Box.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js#L35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dd class="tag-default" style="margin-left: 100px;"><ul class="dummy">
            <pre style="line-height: 1.4; word-wrap: break-word; display: block;">
              <code style="display: block;">geometry: ['width', 'height', 'depth', 'widthSegments', 'heightSegments', 'depthSegements']</code>
            </pre>
        </ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js">components/meshes/Box.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js#L66">line 66</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js">components/meshes/Box.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Box.js#L57">line 57</a>
    </li></ul></dd>
