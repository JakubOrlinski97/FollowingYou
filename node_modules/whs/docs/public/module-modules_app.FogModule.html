...
<head>
    ...
    <title>FogModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>FogModule</h1>
...
<div class="section-method" id="FogModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new FogModule<span class="signature">(params<span class="signature-attributes">opt</span>, type<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/FogModule.js">modules/app/FogModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/FogModule.js#L3">line 3</a>
    </li></ul></dd>
...
<span class="param-type"><code>String</code></span>
            ...
            <td class="description last">
                <p>The type of fog - exp2 or linear</p>
...
<h5>Example</h5>
        ...
        <p class="code-caption">How to create and apply a FogModule</p>
    
    <pre class="prettyprint"><code>const fogModule = new FogModule({
   color: 0xffffff,
   density: 0.03,
   near: 20,
   far: 200
