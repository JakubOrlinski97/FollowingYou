...
<head>
    ...
    <title>VirtualMouseModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>VirtualMouseModule</h1>
...
<div class="section-method" id=".VirtualMouseModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new VirtualMouseModule<span class="signature">(globalMovement<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js">modules/app/VirtualMouseModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js#L6">line 6</a>
    </li></ul></dd>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>globalMovement</code></td>
...
<div class="section-members" id="ray">
<h4 class="name"><span class="type-signature"></span><span class="dot">.</span>ray<span class="type-signature"> :THREE.Ray</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js">modules/app/VirtualMouseModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js#L188">line 188</a>
    </li></ul></dd>
    ...
    <!--<h5>Type: 
<span class="param-type"><code>THREE.Ray</code></span>
...
<div class="section-method" id=".hovers">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>hovers<span class="signature">(component, nested)</span><span class="type-signature"> &rarr; {Boolean}</span></h4>
...
<div class="description">
    <p>Returns a boolean based on intersection data (Whether mouse hovers the component)</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js">modules/app/VirtualMouseModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js#L171">line 171</a>
    </li></ul></dd>
...
<span class="param-type"><code>Component</code></span>
            ...
            <td class="description last">
                <p>A component that intersects with mouse ray (or doesn't)</p>
...
<span class="param-type"><code>Boolean</code></span>
            ...
            <td class="description last">
                <p>Whether component's children should be affected or not</p>
...
<div class="param-desc">
    <p>Whether the component is hovered.</p>
</div>
...
<div class="section-method" id=".intersection">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>intersection<span class="signature">(component, nested)</span><span class="type-signature"> &rarr; {Array}</span></h4>
...
<div class="description">
    <p>Returns an intersection data</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js">modules/app/VirtualMouseModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js#L126">line 126</a>
    </li></ul></dd>
...
<div class="section-method" id=".project">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>project<span class="signature">(plane<span class="signature-attributes">opt</span>, target<span class="signature-attributes">opt</span>)</span><span class="type-signature"> &rarr; {Vector3}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js">modules/app/VirtualMouseModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js#L153">line 153</a>
    </li></ul></dd>
...
<span class="param-type"><code>THREE.Plane</code></span>
...
<span class="param-type"><code>Vector3</code></span>
...
<div class="section-method" id=".track">

    

    <h4 class="name"><span class="type-signature">(static) </span><span class="dot">.</span>track<span class="signature">(component, nested)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Starts tracking events on a component</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js">modules/app/VirtualMouseModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/VirtualMouseModule.js#L84">line 84</a>
    </li></ul></dd>
...
<span class="param-type"><code>Component</code></span>
            ...
            <td class="description last">
                <p>A component, that should be tracked by the mouse</p>
...
<footer>
    Generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.3</a><strong> on Tue Jul 18 2017 14:25:34 GMT+0300 (EEST)</strong>. Inspired by <a href="http://stack.gl/packages/">stack.gl</a>
