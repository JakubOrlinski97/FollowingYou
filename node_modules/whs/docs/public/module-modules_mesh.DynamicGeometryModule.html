...
<head>
    ...
    <title>DynamicGeometryModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>DynamicGeometryModule</h1>
...
<div class="section-method" id="DynamicGeometryModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new DynamicGeometryModule<span class="signature">(params<span class="signature-attributes">opt</span>, patchEvents<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/DynamicGeometryModule.js">modules/mesh/DynamicGeometryModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/mesh/DynamicGeometryModule.js#L1">line 1</a>
    </li></ul></dd>
...
<span class="param-type"><code>Object</code></span>
        ...
        <tr>
                ...
                <td class="name"><code>patchEvents</code></td>
