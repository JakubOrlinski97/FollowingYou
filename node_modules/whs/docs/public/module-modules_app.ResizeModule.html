...
<head>
    ...
    <title>ResizeModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>ResizeModule</h1>
  ...
  <div class="sidebar">
    ...
    <ul>
      ...
      <ul class="sub ">
        ...
        <li><a href="#addAutoresize">.addAutoresize()</a></li>
...
<div class="section-method" id="ResizeModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new ResizeModule<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js">modules/app/ResizeModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js#L3">line 3</a>
    </li></ul></dd>
...
<span class="param-type"><code>Object</code></span>
            ...
            <td class="description last">
                <p>If auto is set to true - resize will be triggered when container resizes</p>
...
<div class="section-method" id="addAutoresize">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>addAutoresize<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Sets module to autoresize, this adds an event listene on window resize to trigger the resize</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js">modules/app/ResizeModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js#L68">line 68</a>
    </li></ul></dd>
...
<div class="section-method" id="addCallback">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>addCallback<span class="signature">(func)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Adds a call back function to the existing callbacks list.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js">modules/app/ResizeModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js#L84">line 84</a>
    </li></ul></dd>
...
<span class="param-type"><code>function</code></span>
            ...
            <td class="description last">
                <p>The callback function to add</p>
...
<div class="section-method" id="createElement">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>createElement<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ElementModule.js">modules/app/ElementModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ElementModule.js#L24">line 24</a>
    </li></ul></dd>
...
<div class="section-method" id="setSize">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>setSize<span class="signature">(width<span class="signature-attributes">opt</span>, height<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>This function sets the provided width &amp; height to the renderer object.</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js">modules/app/ResizeModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js#L21">line 21</a>
    </li></ul></dd>
...
<span class="param-type"><code>Number</code></span>
            ...
            <td class="description last">
                <p>that is resolved when all promises completed.</p>
...
<div class="section-method" id="trigger">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>trigger<span class="signature">()</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Triggers resize when called. width &amp; height are determined automatically
This invokes each callbacks with the new width and height as params</p>
</div>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js">modules/app/ResizeModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/ResizeModule.js#L43">line 43</a>
    </li></ul></dd>
