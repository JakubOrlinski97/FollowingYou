...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Plane</h1>
...
<header>
        ...
        Plane
            ...
            <div class="class-description"><iframe src="https://threejs.org/docs/scenes/geometry-browser.html#PlaneGeometry"></iframe></div>
...
<div class="section-method" id="Plane">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Plane<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p><code>Plane</code> is used for creating planes given some <code>width</code> and <code>height</code>.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js">components/meshes/Plane.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a Plane, and adding to app</p>
    
    <pre class="prettyprint"><code>new Plane({
  geometry: {
    width: 20,
    height: 30
  },
              ...
              <code style="display: block;"><pre>
{
  geometry: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js">components/meshes/Plane.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js#L31">line 31</a>
    </li></ul></dd>
              ...
              <code style="display: block;"><pre>
{
  geometry: ['width', 'height', 'wSegments', 'hSegments']
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js">components/meshes/Plane.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js#L68">line 68</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js">components/meshes/Plane.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Plane.js#L59">line 59</a>
    </li></ul></dd>
