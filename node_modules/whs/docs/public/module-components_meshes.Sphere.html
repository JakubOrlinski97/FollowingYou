...
<head>
    ...
    <title>Sphere - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Sphere</h1>
...
<header>
        ...
        Sphere
            ...
            <div class="class-description"><iframe src="https://threejs.org/docs/scenes/geometry-browser.html#SphereGeometry"></iframe></div>
...
<div class="section-method" id="Sphere">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Sphere<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Sphere class is used to create sphere objects by its radius property and other values that determines its detality.
<br/><br/>
It is similar to THREE.SphereGeometry, but it also contains all <code>Shape</code> properties, such as material, mass and vectors like position (pos) and rotation (rot).
<br/><br/>
Then it creates an <code>Three.js mesh</code> or a <code>Physijs mesh</code>, that is similar to <code>Three.js mesh</code>, but it also take into consideration collision calculations.
This mesh is a combination of <code>Three.js geometry</code> and <code>Physijs material</code> (The same as in three.js, but with friction and restitution).</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js">components/meshes/Sphere.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a Sphere, and adding it to app</p>
    
    <pre class="prettyprint"><code>new Sphere({
  geometry: {
    radius: 2
  },
              ...
              <code style="display: block;"><pre>
{
  geometry: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js">components/meshes/Sphere.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js#L39">line 39</a>
    </li></ul></dd>
              ...
              <code style="display: block;"><pre>
{
  geometry: ['radius', 'widthSegments', 'heightSegments']
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js">components/meshes/Sphere.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js#L67">line 67</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js">components/meshes/Sphere.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Sphere.js#L58">line 58</a>
    </li></ul></dd>
