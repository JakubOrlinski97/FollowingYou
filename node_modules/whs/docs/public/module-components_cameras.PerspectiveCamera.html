...
<head>
    ...
    <title>PerspectiveCamera - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>PerspectiveCamera</h1>
...
<div class="section-method" id="PerspectiveCamera">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new PerspectiveCamera<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Camera with perspective projection.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/PerspectiveCamera.js">components/cameras/PerspectiveCamera.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/PerspectiveCamera.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Create an PerspectiveCamera and set it as app's camera</p>
    
    <pre class="prettyprint"><code>const camera = new PerspectiveCamera({
  fov: 75,
              ...
              <code style="display: block;"><pre>
{
  ...
  aspect: system.window.innerWidth / system.window.innerHeight
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/PerspectiveCamera.js">components/cameras/PerspectiveCamera.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/cameras/PerspectiveCamera.js#L36">line 36</a>
    </li></ul></dd>
