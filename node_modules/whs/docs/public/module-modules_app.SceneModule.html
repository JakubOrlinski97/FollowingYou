...
<head>
    ...
    <title>SceneModule - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>SceneModule</h1>
...
<div class="section-method" id="SceneModule">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new SceneModule<span class="signature">(willSceneBeReplaced<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/SceneModule.js">modules/app/SceneModule.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/modules/app/SceneModule.js#L3">line 3</a>
    </li></ul></dd>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>willSceneBeReplaced</code></td>
...
<span class="param-type"><code>Boolean</code></span>
            ...
            <td class="description last">
                <p>willSceneBeReplaced should be true only if you are going to overwrite scene dependency even without the use of default one.</p>
