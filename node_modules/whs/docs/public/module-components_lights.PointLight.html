...
<head>
    ...
    <title>PointLight - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>PointLight</h1>
...
<div class="section-method" id="PointLight">

    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new PointLight<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>PointLight creates a light at a specific position in the scene. The light shines in all directions (roughly similar to a light bulb.)<br/><br/>
It has the same options as AmbientLight in light paramater, but it also supports position, distance and decay.<br/></p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/lights/PointLight.js">components/lights/PointLight.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/lights/PointLight.js#L6">line 6</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a PointLight</p>
    
    <pre class="prettyprint"><code>new PointLight( {
  color: 0xff0000,
  intensity: 2,
  distance: 300
