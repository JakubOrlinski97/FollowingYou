...
<head>
    ...
    <title>SpotLight - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>SpotLight</h1>
...
<header>
        ...
        SpotLight
            ...
            <div class="class-description"><iframe src="https://threejs.org/examples/webgl_lights_spotlight.html"></iframe></div>
...
<div class="section-method" id="SpotLight">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new SpotLight<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>SpotLight creates spot light that can cast shadow in one direction. <br/><br/>
It has the same parameters as AmbientLight in light, but it also supports pos and target. <br/><br/>
SpotLight affects meshes with lambert and phong material.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/lights/SpotLight.js">components/lights/SpotLight.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/lights/SpotLight.js#L6">line 6</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a SpotLight that falls down from vec3(10, 20, 10) to vec3(0, 0, 0)</p>
    
    <pre class="prettyprint"><code>new SpotLight({
  color: 0x00ff00,
  intensity: 3,
  distance: 1000
