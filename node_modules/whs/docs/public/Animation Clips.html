...
<head>
    ...
    <title>Animation Clips - Documentation</title>
...
[].slice.call(folders).forEach(function (folder) {
  folder.addEventListener('click', function() {
    ...
    <section class="readme">
        <article><h1>Animation Clips</h1><p>The Animation Module provides a convenient approach to animate your models.
Three.js provides an animation system, but you would need to setup the animation mixer, actions, and clips for your  models.
With the <code>AnimationModule</code>, a few lines of code is enough to get going with playing various loops your models might have.</p>
<h3>Pipeline</h3><p>A simple pipeline with Blender to get animated models on the browser:</p>
<h4>Blender</h4><ul>
<li>Model your mesh</li>
</ul>
<p>Modeling your mesh first, here is the model used in the Alien animation example.</p>
<p><img src="images/animation-clips/alien-model.png" alt="Modeling" title="Modeling"></p>
<ul>
<li>Add bones</li>
</ul>
<p>Then add bones to form the armature of the model for animation.</p>
<p><img src="images/animation-clips/alien-bones.png" alt="Bones" title="Bones"></p>
<ul>
<li>Weight assign (Skin/Rig)</li>
</ul>
<p>Assign weight to vertices for the bones to influence.</p>
<p><img src="images/animation-clips/alien-weights-to-bones.png" alt="Weights" title="weights"></p>
<ul>
<li>Add animation frames</li>
</ul>
<p>Create frames to start animating, here using animation frames.
Use the dope sheet/actions editor.</p>
<p><img src="images/animation-clips/alien-add-frames.png" alt="Frames" title="frames"></p>
<ul>
<li>Animation names</li>
</ul>
<p>Your model might have multiple animations (actions/clips), here is the given name for the single animation created for this model.</p>
<p><img src="images/animation-clips/alien-animation-name.png" alt="Action name" title="action name"></p>
<ul>
<li>Export</li>
</ul>
<p>Finally, export to three.js json format, use the Blender exporter plugin, and ticket the appropriate options.</p>
<p><img src="images/animation-clips/alien-export.png" alt="Export" title="Export"></p>
<h4>Whitestorm</h4><ul>
<li>Create the animation module, passing your <code>app</code> as parameter.</li>
</ul>
<pre class="prettyprint source lang-js"><code>const animationModule = new AnimationModule(app);</code></pre><ul>
<li>Import your model as a SkinnedMesh, then play your clip</li>
</ul>
<pre class="prettyprint source lang-js"><code>new Importer({
...
});</code></pre><p>That's it. The clip will kick off after the model is loaded, playing the given clip name.</p></article>
    </section>
