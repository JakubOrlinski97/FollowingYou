...
<head>
    ...
    <title>Circle - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title"><span class="sub"></span>Circle</h1>
...
<header>
        ...
        Circle
            ...
            <div class="class-description"><iframe src="https://threejs.org/docs/scenes/geometry-browser.html#CircleGeometry"></iframe></div>
...
<div class="section-method" id="Circle">

    
    <h2>Constructor</h2>
    

    <h4 class="name"><span class="type-signature"></span><span class="dot">.</span>new Circle<span class="signature">(params<span class="signature-attributes">opt</span>)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>As told on Component definition, while you can pass any of the inherited params for this component construction, you will need to
pass specific parameters to build this mesh as a geometry object.</p>
</div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js">components/meshes/Circle.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js#L7">line 7</a>
    </li></ul></dd>
...
<h5>Example</h5>
        ...
        <p class="code-caption">Creating a Circle, and adding to app</p>
    
    <pre class="prettyprint"><code> new Circle({
   geometry: {
     radius: 4,
     segments: 16
   },
              ...
              <code style="display: block;"><pre>
{
  geometry: {
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js">components/meshes/Circle.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js#L34">line 34</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dd class="tag-default" style="margin-left: 100px;"><ul class="dummy">
            <pre style="line-height: 1.4; word-wrap: break-word; display: block;">
              <code style="display: block;">geometry: ['radius', 'segments', 'thetaStart', 'thetaLength']</code>
            </pre>
        </ul></dd>
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js">components/meshes/Circle.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js#L63">line 63</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js">components/meshes/Circle.js</a>, <a href="https://github.com/WhitestormJS/whitestorm.js/blob/dev/src/components/meshes/Circle.js#L54">line 54</a>
    </li></ul></dd>
